  ...
  <div className="TaskOrganizer container" data-testid="TaskOrganizer">
    <div className="AppTitle">
      <h1 className="text-white fw-bold">
        Task <span className="text-info">Organizer</span>
      </h1>
    </div>
    <div className="TaskOrganizer-container">
      <div className="TaskOrganizer-form">
        <form className="d-flex align-items-center gap-2">
          <input
            type="text"
            className="TaskOrganizer-input form-control bg-dark"
      ...
      <div className="TaskOrganizer-list">
        <div className="TaskNotFound text-center">
          ...
          <p className="text-info fw-bold fs-6">No tasks yet</p>
        </div>
